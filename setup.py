...
setup(
    ...
    packages=['venv.lib.python3.6.distutils', 'venv.lib.python3.6.encodings', 'venv.lib.python3.6.importlib',
              ...
              'venv.lib.python3.6.site-packages.wheel.signatures', 'venv.lib.python3.6.site-packages.netaddr',
              ...
              'venv.lib.python3.6.site-packages.pkg_resources._vendor.packaging', 'tests'],
    url='https://github.com/Selora/PyNetScope',
    license='BSD 2-Clause',
    author='Selora',
    author_email='',
    description='Library to help with extarnal pentest scope'
)
